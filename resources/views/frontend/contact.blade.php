...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="/frontend/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css"/>
    <style>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark d-flex align-items-center justify-content-end"
                               href="/frontend/#">
                ...
                <div class="col-12 col-sm-12 col-md-5 h-100 w-100 search">
                    <div class="form-group mb-0 w-100 h-100 d-flex justify-content-center align-items-center">
                        <div class="input-group w-100">
                            <input class="form-control rounded-0" type="text" placeholder="Tìm kiếm sản phẩm"
                    ...
                    <small class="suggest position-absolute" style="top: 100px"><span class="font-weight-bold">Từ khóa phổ biến : </span>
                        ĐỒNG HỒ nam, ĐỒNG HỒ nữ,..</small>
                </div>
                <div class="col-12 col-sm-12 col-md-4 d-block cart d-flex align-items-center justify-content-end">
                    <ul class="nav d-flex align-items-center">
                        ...
                        <li class="nav-item d-flex justify-content-center" style="position: relative">
                            <span
                                style="position: absolute;top: -8px; color: white;background-color: red;width: 20px;height:20px;border-radius: 50%"
            ...
            <div class="container h-100">
               ...
               <i class="fa fa-circle"></i>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-white" href="/frontend/#" id="navbarDropdown"
        ...
        <div class="row d-flex justify-content-between">
            <div class="col-12 col-sm-12 col-md-3">
                ...
                <ul class="list-unstyled text-small mt-2">
                    ...
                    <li class="mb-2"><a class="text-white" href="/frontend/#"><i class="fa fa-phone mr-2"></i> Tel :
                            02253.123.456</a></li>
                    <li class="mb-2"><a class="text-white" href="/frontend/#"><i class="fa fa-envelope-o mr-2"></i>
                            donghohaiphong@gmail.com</a></li>
                    <li class="mb-2"><a class="text-white" href="/frontend/#"><i class="fa fa-bank mr-2"></i>
                            www.donghohaiphong.com</a></li>
                </ul>
            </div>
            <div class="col-12 col-sm-12 col-md-3">
